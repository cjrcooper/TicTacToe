...
! function(e, t) {
    ...
    function n() {
        ...
        function i(t) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(a)) {
                for (var l = o.target || o.srcElement, s = -1, i = 0; i < S.length; i++)
                    if (l === S[i]) {
                        s = i;
                        break
                    }
                if (9 === a) {
                    if (!r) return;
                    o.shiftKey ? n(s, -1) : n(s, 1), A(o)
                } else 13 === a || 32 === a ? -1 === s && H(k, o) : 27 === a && u.allowEscapeKey === !0 && H(B, o)
            }
        }
        ...
        var y, p = function(t) {
                ...
                switch (n.type) {
                    ...
                    case "mouseup":
                    case "focus":
                        u.buttonsStyling && (r ? o.style.backgroundColor = a(u.confirmButtonColor, -.1) : l && (o.style.backgroundColor = a(u.cancelButtonColor, -.1)));
                        break;
                    case "mouseout":
                    case "blur":
                        u.buttonsStyling && (r ? o.style.backgroundColor = u.confirmButtonColor : l && (o.style.backgroundColor = u.cancelButtonColor));
                        break;
                    case "mousedown":
                        u.buttonsStyling && (r ? o.style.backgroundColor = a(u.confirmButtonColor, -.2) : l && (o.style.backgroundColor = a(u.cancelButtonColor, -.2)));
                        break;
                    case "click":
                        r && u.callback && i ? (u.callback(!0), u.closeOnConfirm && s()) : u.callback && i ? (u.callback.length > 0 && u.callback(!1), u.closeOnCancel && s()) : s()
                }
            },
            v = f.querySelectorAll("button");
        for (y = 0; y < v.length; y++) v[y].onclick = p, v[y].onmouseover = p, v[y].onmouseout = p, v[y].onmousedown = p;
        m = t.onclick, t.onclick = function(t) {
            var n = t || e.event,
                o = n.target || n.srcElement;
            o === h() && u.allowOutsideClick && (s(), "function" == typeof u.callback && u.callback())
        };
        var k = f.querySelector("button.sweet-confirm"),
            B = f.querySelector("button.sweet-cancel"),
            S = f.querySelectorAll("button, input:not([type=hidden]), textarea, select");
        for (y = 0; y < S.length; y++) S[y].onfocus = p, S[y].onblur = p;
    ...
    function o(n) {
        ...
        var l = o.querySelector("h2"),
            ...
            u = o.querySelector("hr.sweet-spacer");
        if (l.innerHTML = S(n.title).split("\n").join("<br>"), e.jQuery ? s = $(s).html(n.html || "<p>" + S(n.text.split("\n").join("<br>")) + "</p>") : (s.innerHTML = n.html || "<p>" + S(n.text.split("\n").join("<br>")) + "</p>", s.innerHTML && E(s)), n.customClass && k(o, n.customClass), T(o.querySelectorAll(".icon")), n.type) {
    ...
    function l() {
        var e = w();
        M(h(), 10), E(e), k(e, "show-sweet-alert"), B(e, "hide-sweet-alert"), u = t.activeElement, setTimeout(function() {
            k(e, "visible")
        }, 500)
    }
    ...
    function s() {
        var e = w();
        q(h()), q(e), B(e, "showSweetAlert"), k(e, "hideSweetAlert"), B(e, "visible");
        ...
        var o = e.querySelector(".icon.warning");
        B(o, "pulse-warning"), B(o.querySelector(".body"), "pulse-warning-ins"), B(o.querySelector(".dot"), "pulse-warning-ins"), i()
    }
    ...
    function i() {
        ...
        var o = t.getElementsByTagName("head")[0],
            a = t.getElementById(p);
        a && o.removeChild(a)
    }

    function c() {
        var e = w();
        e.style.marginTop = L(w())
    }
    var u, m, d, g, f = ".sweet-alert",
        y = ".sweet-overlay",
